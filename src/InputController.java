...
public class InputController {
    ...
    public void submitUS(ActionEvent event) throws IOException {
        ...
        outputController.displayCalories(calculateUS(age, getGender(), feetHeight, inchHeight, poundsWeight, USActivity));
    ...
    public int calculateUS(int age, boolean gender, int feetHeight, int inchHeight, int poundsWeight, int USActivity) {
        System.out.println(poundsWeight);
    ...
    public int calculateMetric(int age, boolean gender, int centimeterHeight, int kilogramsWeight, int metricActivity){
        if(metricActivity == 1) {
            ...
            if (gender) {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) + 5) * 1.4);
            } else {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) - 161) * 1.4);
            }
        }else if(metricActivity == 4){
            if (gender) {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) + 5) * 1.6);
            } else {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) - 161) * 1.6);
            }
        }else if(metricActivity == 5){
            if (gender) {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) + 5) * 1.8);
            } else {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) - 161) * 1.8);
            }
        }else if(metricActivity == 6){
            if (gender) {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) + 5) * 2);
            } else {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) - 161) * 2);
            }
        }else if(metricActivity == 7){
            if (gender) {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) + 5) * 100);
            } else {
                return (int) (((10 * kilogramsWeight) + (6.25 * centimeterHeight) - (5 * age) - 161) * 100);
            }
        }
        return 2000;
    }
